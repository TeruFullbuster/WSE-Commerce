...
import { updateProspectoEcommerce, POSTSesion , PutSesion, PutPass , 
    ...
    UpdateDescCot, GetCotChatbot, UpdateNumber, SendMessageAutomatizado,UpdateNumberTicket } from '../controllers/Sesiones.controllers.js'
...
router.put('/UpdateNumberTicket/:id', UpdateNumberTicket);
